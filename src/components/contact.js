    ...
    <section id='contact'>
        ...
        <div id='code'>
            ...
            <div className='CodeImgs'>
                <a href='https://leetcode.com/u/kuchbhi90/'><img src={LeetCode} alt='LeetCode' className='codeImg' /> </a>
        ...
        <div id='social'>
            ...
            <div className='socialImgs'>
                <a href='https://www.linkedin.com/in/archit-sharma-3bbb132b8/'><img src={Linkdin} alt='Linkdin' className='socialImg' /> </a>
                <a href='https://github.com/'><img src={Github} alt='Github' className='socialImg' /> </a>
                <a href='https://www.instagram.com/'><img src={Instagram} alt='Instagram' className='socialImg' /> </a>
                <a href='https://www.facebook.com/login/'><img src={Facebook} alt='Facebook' className='socialImg' /> </a>
            </div>
        </div>
